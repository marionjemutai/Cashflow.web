  ...
  return (
    <div className="flex h-screen w-full bg-[#F8FAFC] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-y-auto">
        ...
        <main className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto w-full space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Stores</h1>
              <p className="text-sm text-gray-500 mt-1">Manage your store locations, managers, and operational status.</p>
            </div>
